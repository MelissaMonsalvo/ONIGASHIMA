...
image frame gal hover = ConditionSwitch(
    "not persistent.loop1", Transform("gui/frame.webp", xysize=(480, 302), matrixcolor=ColorizeMatrix(YELLOW, YELLOW)),
